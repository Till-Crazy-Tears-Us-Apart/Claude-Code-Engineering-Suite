...
| **Interaction** | Simplified Chinese | Protocol headers and output forced to Chinese |
...
├── language.md                     # Language config (Simplified Chinese)
...
└── hooks/                          # Automated hook system
    ...
    │   └── reminder_prompt.md      # Constraint prompt config
